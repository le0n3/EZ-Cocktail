        ...
        <div class="container">
            <div class="row mb-2">
                <div class="col">
                    ...
                    <input disabled type="text" class="form-control" id="Zutat" name="Zutat" value="<?php echo !is_null($ingredient) ? $ingredient->getIngredient(): ''; ?>">
                </div>
            </div>
            <div class="row mb-2">
                <div class="col">
                ...
                <div class="col">
                    ...
                    <input disabled type="text" class="form-control" id="Einheit" name="Einheit" value="<?php echo !is_null($ingredient) ? $ingredient->getUnit(): ''; ?>">
                </div>
            </div>
            <div class="row mb-2">
                <div class="col">
                    <label for="Typ" class="form-label">Typ</label>
                    <input disabled type="text" class="form-control" id="Typ" name="Typ" value="<?php echo !is_null($ingredient) ? $ingredient->getType(): ''; ?>">
                </div>
            </div>
            <div class="row mb-2">
                <label for="Beschreibung" class="form-label">Beschreibung</label>
                <textarea disabled class="form-control ms-2" id="Beschreibung" name="Beschreibung" rows="3" style="width: 96%;"> <?php echo !is_null($ingredient) ? $ingredient->getDescription(): ''; ?></textarea>
            </div>
        </div>
    </div>
